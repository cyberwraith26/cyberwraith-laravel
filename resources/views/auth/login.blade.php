...
<div style="width:100%;max-width:420px;">
    ...
    <div style="text-align:center;margin-bottom:2.5rem;">
        <div class="font-mono" style="font-size:0.6rem;color:rgba(0,255,136,0.5);letter-spacing:0.3em;text-transform:uppercase;margin-bottom:0.75rem;">// AUTH.login()</div>
        <h1 style="font-size:2rem;font-weight:800;color:#fff;margin-bottom:0.5rem;">Welcome Back</h1>
        <p style="font-size:0.82rem;color:rgba(255,255,255,0.35);">Enter your credentials to access your dashboard.</p>
    </div>
    ...
    <div style="background:#0a1520;border:1px solid rgba(0,255,136,0.15);padding:2.5rem;position:relative;">
        ...
        @if(session('status'))
            <div style="background:rgba(0,255,136,0.05);border:1px solid rgba(0,255,136,0.2);color:#00ff88;padding:0.75rem 1rem;font-family:'JetBrains Mono',monospace;font-size:0.7rem;margin-bottom:1.5rem;">
                {{ session('status') }}
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('login') }}" style="display:flex;flex-direction:column;gap:1.25rem;">
            ...
            <div>
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:0.4rem;">
                    <label style="font-family:'JetBrains Mono',monospace;font-size:0.6rem;color:rgba(0,255,136,0.6);letter-spacing:0.15em;text-transform:uppercase;">Password</label>
                    <a href="{{ route('password.request') }}" style="font-family:'JetBrains Mono',monospace;font-size:0.58rem;color:rgba(255,255,255,0.25);text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='#00ff88'" onmouseout="this.style.color='rgba(255,255,255,0.25)'">Forgot password?</a>
                </div>
                <div style="position:relative;">
                    <input type="password" name="password" id="login-password" placeholder="••••••••" required
                        ...
                        onfocus="this.style.borderColor='rgba(0,255,136,0.5)'" onblur="this.style.borderColor='rgba(0,255,136,0.2)'">
                    <button type="button" onclick="togglePassword('login-password','eye-lp')" style="position:absolute;right:0.75rem;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:rgba(0,255,136,0.4);padding:0;display:flex;align-items:center;transition:color 0.2s;" onmouseover="this.style.color='#00ff88'" onmouseout="this.style.color='rgba(0,255,136,0.4)'">
                        <svg id="eye-lp" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div style="display:flex;align-items:center;gap:0.6rem;">
                <input type="checkbox" name="remember" id="remember" style="width:14px;height:14px;accent-color:#00ff88;cursor:pointer;flex-shrink:0;">
                <label for="remember" style="font-family:'JetBrains Mono',monospace;font-size:0.62rem;color:rgba(255,255,255,0.3);letter-spacing:0.05em;cursor:pointer;user-select:none;">Remember me</label>
            </div>
    ...
    <p style="text-align:center;margin-top:1.5rem;font-family:'JetBrains Mono',monospace;font-size:0.65rem;color:rgba(255,255,255,0.2);">
        No account?
        <a href="{{ route('register') }}" style="color:rgba(0,255,136,0.6);text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='#00ff88'" onmouseout="this.style.color='rgba(0,255,136,0.6)'">Create one free →</a>
    </p>
</div>
